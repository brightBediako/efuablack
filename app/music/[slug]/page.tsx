        ...
        <section className="relative flex min-h-[min(716px,90dvh)] w-full items-center justify-center overflow-hidden md:h-[716px] md:min-h-0">
          <div className="absolute inset-0 bg-primary z-0">
            <img
              ...
              src="https://res.cloudinary.com/dkg8ovask/image/upload/q_auto/f_auto/v1776050990/1_di4sq2.jpgU"
            />
          ...
          <div className="relative z-10 text-center px-6 max-w-4xl">
            ...
            <p className="text-xl md:text-2xl font-headline italic text-on-surface-variant max-w-2xl mx-auto opacity-90">
              A soul-stirring anthem of grace, redemption, and the unwavering
              light that guides us through the shadows.
            </p>
          </div>
        </section>
            ...
            <div className="lg:col-span-7 space-y-12">
              ...
              <div className="bg-surface-container-low p-10 md:p-14 rounded-xl">
                ...
                <div className="space-y-6 text-on-surface-variant leading-relaxed text-lg">
                  <p>
                    Written during a season of profound reflection,
                    &quot;Testify&quot; serves as a musical testimony to the
                    transformative power of faith. Efua Black blends her
                    signature gospel roots with a contemporary cinematic
                    soundscape, creating a journey that is both intimate and
                    expansive.
                  </p>
                  <p>
                    The track features a lush orchestral arrangement paired with
                    powerful choral backing, emphasizing the communal aspect of
                    worship and the personal joy of spiritual liberation.
                  </p>
                </div>
                <div className="mt-12 flex flex-wrap gap-4">
                  ...
                  >
                    ...
                    <span className="font-label font-bold uppercase tracking-wider text-sm">
                      Apple Music
                    </span>
                  </button>
                  <button
            ...
            <div className="lg:col-span-5 space-y-12">
              <div className="flex items-center justify-between p-6 bg-surface-container-lowest rounded-xl shadow-sm">
                <div className="flex items-center gap-4">
                  <button
                    type="button"
                    className="p-3 rounded-full hover:bg-secondary-container transition-colors group"
                  >
                    <MaterialSymbol
                      name="share"
                      className="text-outline group-hover:text-on-secondary-container"
                    />
                  </button>
                  <button
                    type="button"
                    className="p-3 rounded-full hover:bg-error-container transition-colors group"
                  >
                    <MaterialSymbol
                      name="favorite"
                      className="text-outline group-hover:text-error"
                    />
                  </button>
                  <button
                    type="button"
                    className="p-3 rounded-full hover:bg-tertiary-fixed transition-colors group"
                  >
                    <MaterialSymbol
                      name="playlist_add"
              ...
              <div className="bg-surface-container-low p-10 md:p-12 rounded-xl border-t-4 border-secondary">
                <div className="flex justify-between items-baseline mb-10">
                  <h3 className="text-3xl font-headline italic text-primary-container">
                    Lyrics
                  </h3>
              ...
              <div className="px-6 py-8 bg-surface-container-lowest rounded-xl">
                <h4 className="font-label text-xs uppercase tracking-[0.2em] text-outline mb-4">
                  Song Credits
                </h4>
                <ul className="space-y-3 text-sm text-on-surface-variant">
                  <li className="flex justify-between">
                    <span>Composer</span>{" "}
                    <span className="font-bold">Efua Black</span>
                  </li>
                  <li className="flex justify-between">
                    <span>Producer</span>{" "}
                    <span className="font-bold">Gabriel Stone</span>
                  </li>
                  <li className="flex justify-between">
                    <span>Backing Vocals</span>{" "}
                    <span className="font-bold">The Grace Ensemble</span>
                  </li>
                  <li className="flex justify-between">
                    <span>Release Date</span>{" "}
                    <span className="font-bold">Nov 12, 2024</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="max-w-screen-xl mx-auto px-6 md:px-12">
            <div className="flex justify-between items-end mb-16">
              <div>
                ...
                <h2 className="text-5xl font-headline italic text-primary-container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div className="md:col-span-2 md:row-span-2 group relative overflow-hidden rounded-xl aspect-square">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-primary/80 to-transparent flex flex-col justify-end p-8">
                  ...
                  <h3 className="text-3xl font-headline italic text-on-primary mb-4">
                    The Morning Light
                  </h3>
                  <button
                    type="button"
              ...
              <div className="group relative overflow-hidden rounded-xl aspect-square">
                ...
                <div className="absolute inset-0 bg-primary/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                  <h3 className="text-on-primary font-headline italic text-xl">
                    Grace Abounds
                  </h3>
                </div>
              </div>
              ...
              <div className="md:col-span-2 group relative overflow-hidden rounded-xl aspect-[2/1]">
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-primary/80 to-transparent flex flex-col justify-center p-8">
                  <h3 className="text-2xl font-headline italic text-on-primary mb-2">
                    Live in London
                  </h3>
